...
export const wsProfileOrdersConnectionSuccess = (): IWSProfileOrdersConnectionSuccessAction => ({
        type: WS_PROFILE_CONNECTION_SUCCESS
});
export const wsProfileOrdersConnectionError = (): IWSProfileOrdersConnectionErrorAction => ({
