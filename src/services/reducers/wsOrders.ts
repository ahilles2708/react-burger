...
import { TWSProfileOrdersActions } from "../../services/actions/wsOrders";
...
export const ordersReducer = (state = initialState, action: TWSProfileOrdersActions): TProfileOrdersState => {
    switch (action.type) {
